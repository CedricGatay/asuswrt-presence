...
PORT_NUMBER = 9090
config={CONF_HOST: environ['WRT_HOST'], CONF_USERNAME: environ['WRT_LOGIN'], CONF_PASSWORD: environ['WRT_PASSWORD'],CONF_PROTOCOL: environ['WRT_PROTOCOL'], CONF_MODE: environ['WRT_MODE'], CONF_PORT: environ['WRT_PORT'] }
